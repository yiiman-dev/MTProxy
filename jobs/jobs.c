...
MODULE_STAT_FUNCTION
  ...
  double jb_cpu_load_u[900];//tokapps 16 to 300
  double jb_cpu_load_s[900];//tokapps 16 to 300
  double jb_cpu_load_t[900];//tokapps 16 to 300
  double jb_cpu_load_ru[900];//tokapps 16 to 300
  double jb_cpu_load_rs[900];//tokapps 16 to 300
  double jb_cpu_load_rt[900];//tokapps 16 to 300
