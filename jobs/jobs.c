...
MODULE_STAT_FUNCTION
  ...
  double tot_recent_idle[2000];//tokapps 300 to 2000
  double tot_recent_q[2000];//tokapps 300 to 2000
  double tot_idle[2000];//tokapps 300 to 2000
  int tot_threads[2000];//tokapps 300 to 2000
  ...
  for (i = 0; i < 2000; i++) {//tokapps from 300 to 2000 *
    if (i != 0) {
      sb_printf (sb, " ");
      if (!(i & 3)) {
        sb_printf (sb, " ");
  ...
  double jb_cpu_load_u[2000];//tokapps 300 to 2000
  double jb_cpu_load_s[2000];//tokapps 300 to 2000
  double jb_cpu_load_t[2000];//tokapps 300 to 2000
  double jb_cpu_load_ru[2000];//tokapps 300 to 2000
  double jb_cpu_load_rs[2000];//tokapps 300 to 2000
  double jb_cpu_load_rt[2000];//tokapps 300 to 2000
  ...
  for (i = 0; i < 2000; i++) {//tokapps 300 to 2000 *
  ...
  for (j = 0; j < 6; j++) {
    ...
    for (i = 0; i < 2000; i++) {//tokapps 3000 to 2000 *
      if (i != 0) {
        sb_printf (sb, " ");
        if (!(i & 3)) {
          sb_printf (sb, " ");
  ...
  int jb_running[300], jb_active = 0;//from 16 to 300
